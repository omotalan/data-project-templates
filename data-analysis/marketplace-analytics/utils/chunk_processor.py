...
class ABConfig:
    ...
    conversion_col:    str      = 'purchased'
    user_id_col:       str      = 'user_id'
    session_id_col:    str      = 'user_session'
    variant_user_col:  str      = 'variant_user'
    variant_session_col: str    = 'variant_session'
...
class ChunkProcessor:
    ...
    def run_ab_aggregation(self,
        ...
        Column names and conversion event driven by ABConfig.
        ...
        level_configs = [
            {
                'name':        'users',
                'id_col':      self.ab_config.user_id_col,
                'variant_col': self.ab_config.variant_user_col,
            },
            {
                'name':        'sessions',
                'id_col':      self.ab_config.session_id_col,
                'variant_col': self.ab_config.variant_session_col,
            },
        ]
            ...
            for cfg in level_configs:
                df = con.execute(f"""
                    SELECT
                        ...
                        SUM({self.ab_config.conversion_col})          AS conversions,
                        SUM({self.ab_config.conversion_col})::FLOAT
